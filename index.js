...
// The MongoDB URI is loaded from environment variables for security.
// It MUST be set on Render.com as an environment variable named MONGODB_URI.
// For local development, you might use a .env file and `dotenv` package,
// but for Render deployment, environment variables are preferred.
const MONGODB_URI = process.env.MONGODB_URI;

// Ensure MONGODB_URI is available before proceeding.
// If it's undefined, the MongoClient will throw an error,
// which is caught and exits the process.
if (!MONGODB_URI) {
    console.error('CRITICAL ERROR: MONGODB_URI environment variable is not set.');
    console.error('Please set MONGODB_URI on Render.com or in your local environment.');
...
// Gmail SMTP Credentials (as provided in your initial request)
